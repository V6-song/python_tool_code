...
#                     # 将子文件夹的名字改为"imgs"
#                     new_name = os.path.join(subfolder_path, 'images')
...
"""
    我会给出你一个文件夹的绝对地址,这个文件夹下有一系列以Video_00命名的子文件夹,
    子文件夹下又有好几个文件夹,这几个文件夹中有一个名字为imgs的文件夹,
    将这个文件夹的名字改为images,如果已经有了名字为images的文件夹,
    那么直接处理下一个文件夹
...
# 调用函数，传入你的文件夹的绝对地址
rename_subfolders('D:/challenging_videos')
#=======================================================================================